...
import starter.trades.RegistrationResponse;
...
public class RegistrationStepDefinitions {
    ...
    @Steps
    RegistrationResponse theTradeDetails;
    ...
    public void the_following_trade(List<Map<String, String>> tradeDetails) throws IOException {
        ...
        requestBody = MergeFrom.template("templates/trade.json")
    ...
    public void i_record_the_trade() {
        recordNewTrade.withDetails(requestBody);
    }
